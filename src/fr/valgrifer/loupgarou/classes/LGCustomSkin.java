...
public class LGCustomSkin {
    ...
    public static final LGCustomSkin VILLAGER = register("VILLAGER", new WrappedSignedProperty("textures",
    ...
    public static final LGCustomSkin MAYOR = register("MAYOR", new WrappedSignedProperty("textures",
    ...
    public static final LGCustomSkin WEREWOLF = register("WEREWOLF", new WrappedSignedProperty("textures",
    ...
    public static LGCustomSkin register(String name, WrappedSignedProperty property) {
        LGCustomSkin cause;
        if ((cause = getSkin(name)) != null) return cause;
